...
vxlan=prepacket/IP(src=vtepsrc,dst=vtepdst, options=IPOption('\x07\x00'+'\x44\x10\x05\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00'+'\x88\x04\x10\x10'+'\x83\x03\x10'))/UDP(sport=1234,dport=vxlanport)/VXLAN(vni=vni,flags="Instance")
